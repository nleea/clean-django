...
class CurrencyExchangeRateEntity:
    ...
    def to_string(exchange_rate: "CurrencyExchangeRateEntity") -> str:
        source_currency = (
            exchange_rate.source_currency.code
            if hasattr(exchange_rate.source_currency, "code")
            else exchange_rate.source_currency
        )
        exchanged_currency = (
            exchange_rate.exchanged_currency.code
            if hasattr(exchange_rate.exchanged_currency, "code")
            else exchange_rate.exchanged_currency
        )
        return (
